<?php
# $Id: starter_layer.php,v 1.8 2013/01/25 10:36:36 rp Exp $
# Starter layer:
...
try {
    ...
    header("Content-Disposition: inline; filename=starter_layer.pdf");
    print $buf;
}
catch (PDFlibException $e) {
    die("PDFlib exception occurred in starter_layer sample:\n" .
