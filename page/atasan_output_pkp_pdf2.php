...
include ('../nigol.php');
	...
	if($row = mysql_fetch_array($hasil2))*/
		...
		BADAN KEPEGAWAIAN DAERAH  <br><br><br><br>
			...
			$html .="Dibuat Tanggal, 31 Desember $year<br>
					...
					<u>$row_get_penilai[nama_pns]</u><br>NIP: $penilai";
			$html .="	</div>";
	//===============
	...
	//======RIGHT=====
		...
		$html .="		$row_get_golrujab[nama_palru]  	<br>
					$row_get_golrujab[nama_jabatan]	<br>
						<br><br>";
		//DINILAI
		$html .="		<br>
					$buaris[nama_pns]  	<br>
		...
		$hasil_lagi  = mysql_query("select a.nip, a.nama_pns, c.nama_palru, b.nama_jabatan, a.unit_kerja, a.jekel, a.tmt, a.level
			       ...
			       where a.id_palru=c.id_palru AND a.id_jabatan=b.id_jabatan AND b.kode2='".$row_get_golrujab['kode2']."' AND a.level='atasan' ORDER BY a.level");
  ...
  <tr>
    ...
    <td >Nama</td>
    <td >$row_get_penilai[nama_pns]</td>
    <td >Nama</td>
  ...
  <tr>
    ...
    <td >Pangkat</td>
    <td >$row_get_golrujab[nama_palru]</td>
    <td >Pangkat</td>
  ...
  <tr>
    ...
    <td >Jabatan</td>
    <td >$row_get_golrujab[nama_jabatan]</td>
    <td >Jabatan</td>
  ...
  $html .="<tr>
    ...
    <td  colspan='2'><form><input type='checkbox' name='QPC' value='ON'> Pengevaluasian kenaikan pangkat<br>
                    ...
                    <input type='checkbox' name='QPC' value='ON'> dan lain-lain<br></form>
    </td>
  </tr>";}
  ...
  $html .="<tr>
    ...
    <td  colspan='2'><input type='checkbox' name='QPC' value='ON'> Penundaan kenaikan gaji berkala selama 1 tahun<br>
  ...
  $html .="<tr>
    ...
    <td  colspan='2'><input type='checkbox' name='QPC' value='ON'> Penurunan pangkat setingkat lebih rendah selama 3 tahun<br>
